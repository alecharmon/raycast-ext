...
function $1f5338676d90e7a6$export$dd6b79aaabe7bc37(fn, args, options) {
    ...
    const callback = (0, $8zHUo$react.useCallback)((...args)=>{
        ...
        async function handleError(error) {
            ...
            if (callId === lastCallId.current) {
                ...
                if (latestOnError.current) try {
                    ...
                    if ((0, $8zHUo$raycastapi.environment).launchType !== (0, $8zHUo$raycastapi.LaunchType).Background) try {
                        await (0, $6c9bb2e572dea89d$export$80e5033e369189f3)(normalizedError, {
        ...
        try {
            ...
            promiseOrPaginatedPromise = $1f5338676d90e7a6$var$bindPromiseIfNeeded(fnRef.current)(...args);
        } catch (error) {
...
const $4edf56917e12e612$var$noOptimisticValue = /* #__PURE__ */ Symbol("no optimistic value");
function $4edf56917e12e612$var$serializeCachedValue(value) {
    if (typeof value === "undefined") return "undefined";
    const serializedValue = JSON.stringify(value, (0, $dfecd32049fa58e9$export$b644b65666fe0c18));
    if (typeof serializedValue === "undefined") throw new Error("Cached state values must be JSON serializable");
    return serializedValue;
}
function $4edf56917e12e612$var$deserializeCachedValue(serializedValue, fallback) {
    if (typeof serializedValue === "undefined") return fallback;
    if (serializedValue === "undefined") return undefined;
    try {
        return JSON.parse(serializedValue, (0, $dfecd32049fa58e9$export$63698c10df99509c));
    } catch (error) {
...
function $4edf56917e12e612$export$14afb9e4c16377d3(key, initialState, config) {
    ...
    const [optimisticState, setOptimisticState] = (0, $8zHUo$react.useState)($4edf56917e12e612$var$noOptimisticValue);
    const pendingWriteRef = (0, $8zHUo$react.useRef)(null);
    const timeoutRef = (0, $8zHUo$react.useRef)(null);
    const flushPendingWrite = (0, $8zHUo$react.useCallback)((resetOptimisticState = true)=>{
        ...
        if (resetOptimisticState) setOptimisticState($4edf56917e12e612$var$noOptimisticValue);
    }, []);
    (0, $8zHUo$react.useEffect)(()=>{
        const pendingWrite = pendingWriteRef.current;
        ...
        setOptimisticState((state)=>state !== $4edf56917e12e612$var$noOptimisticValue && state.key !== key ? $4edf56917e12e612$var$noOptimisticValue : state);
    }, [
        cache,
    ...
    const state = (0, $8zHUo$react.useMemo)(()=>{
        if (optimisticState !== $4edf56917e12e612$var$noOptimisticValue && optimisticState.key === key) return optimisticState.value;
        return $4edf56917e12e612$var$deserializeCachedValue(cachedState, initialValueRef.current);
    }, [
        cachedState,
        initialValueRef,
        key,
    ...
    const setStateAndCache = (0, $8zHUo$react.useCallback)((updater)=>{
        ...
        if (pendingWrite && pendingWrite.cache === cache && pendingWrite.key === currentKey) currentValue = pendingWrite.value;
            ...
            currentValue = $4edf56917e12e612$var$deserializeCachedValue(cache.get(currentKey), initialState);
        } catch (error) {
            console.error("Could not get Cache data:", error);
        ...
        const serializedValue = $4edf56917e12e612$var$serializeCachedValue(newValue);
        ...
        if (typeof debounce === "undefined" || debounce === null || debounce < 0) {
            ...
            setOptimisticState($4edf56917e12e612$var$noOptimisticValue);
        } else {
            ...
            timeoutRef.current = setTimeout(()=>{
                ...
                setOptimisticState((state)=>state !== $4edf56917e12e612$var$noOptimisticValue && state.key === newPendingWrite.key ? $4edf56917e12e612$var$noOptimisticValue : state);
            }, debounce);
        }
        return newValue;
    }, [
...
function $a9b0b6f46ce12461$export$b15740c74e256244(fn, args, options) {
   ...
   */ const { initialData: initialData, keepPreviousData: keepPreviousData, internal_cacheKeySuffix: internal_cacheKeySuffix, cacheWriteDebounce: cacheWriteDebounce, ...usePromiseOptions } = options || {};
    ...
    const cacheKey = (0, $dfecd32049fa58e9$export$d6af199866bfb566)(args || []) + internal_cacheKeySuffix;
    const [cachedData, mutateCache] = (0, $4edf56917e12e612$export$14afb9e4c16377d3)(cacheKey, $a9b0b6f46ce12461$var$emptyCache, {
    ...
    const latestCacheKey = (0, $07a180af23fbf38b$export$d4b699e2c1148419)(cacheKey);
...
async function $d1b00242b8395b80$var$getRequestInfoCacheKey(requestInfo) {
    ...
    return (0, $dfecd32049fa58e9$export$d6af199866bfb566)({
        body: body,
...
function $d1b00242b8395b80$var$getUrlFactoryErrorCacheKey(url, error) {
    ...
    return `url-factory-error:${(0, $dfecd32049fa58e9$export$d6af199866bfb566)([
        url.toString(),
        normalizedError
    ])}`;
}
function $d1b00242b8395b80$var$combineAbortSignals(...signals) {
...
function $d1b00242b8395b80$export$d852f5f778460fa4(url, options) {
    ...
    const paginatedUrlRef = (0, $8zHUo$react.useRef)(null);
    const firstPageErrorRef = (0, $8zHUo$react.useRef)(null);
    const [paginatedRequest, setPaginatedRequest] = (0, $8zHUo$react.useState)(null);
    const [resolvedRequest, setResolvedRequest] = (0, $8zHUo$react.useState)(null);
    ...
    (0, $8zHUo$react.useEffect)(()=>{
        ...
        (async ()=>{
            ...
            try {
                ...
                cacheKey = await $d1b00242b8395b80$var$getRequestInfoCacheKey(requestInfo);
            } catch (error) {
                firstPageError = {
                    error: error
                };
                cacheKey = $d1b00242b8395b80$var$getUrlFactoryErrorCacheKey(paginatedUrl, error);
            }
            if (cancelled) return;
    ...
    (0, $8zHUo$react.useEffect)(()=>{
        ...
        let cancelled = false;
        $d1b00242b8395b80$var$getRequestInfoCacheKey(url).then((cacheKey)=>{
            ...
            if (!cancelled) setResolvedRequest({
                request: url,
                cacheKey: `request-error:${(0, $dfecd32049fa58e9$export$d6af199866bfb566)(String(error))}`
            });
        });
        return ()=>{
            cancelled = true;
    ...
    const paginatedFn = (0, $8zHUo$react.useCallback)((url, options)=>async (pagination)=>{
            ...
            const signal = $d1b00242b8395b80$var$combineAbortSignals(abortable.current?.signal, options?.signal, requestInfo instanceof Request ? requestInfo.signal : undefined);
    ...
    const fn = (0, $8zHUo$react.useCallback)(async (url, options)=>{
        ...
        const signal = $d1b00242b8395b80$var$combineAbortSignals(abortable.current?.signal, options?.signal, url instanceof Request ? url.signal : undefined);
        const res = await fetch(request, {
            ...options,
            signal: signal
        });
    ...
    const result = (0, $a9b0b6f46ce12461$export$b15740c74e256244)(promise, [
        requestInfo,
        fetchOptions
    ], {
        ...useCachedPromiseOptions,
        execute: isPaginated ? execute !== false && paginatedRequest !== null : !isResolvingRequestCacheKey && execute,
        internal_cacheKeySuffix: (isPaginated ? paginatedRequest?.cacheKey : requestCacheKey || "") + (0, $dfecd32049fa58e9$export$d6af199866bfb566)(mapResultRef.current) + (0, $dfecd32049fa58e9$export$d6af199866bfb566)(parseResponseRef.current),
        abortable: abortable
    });
...
async function $3122cfee675f370d$var$cache(url, destination, fetchOptions) {
    const temporaryDestination = `${destination}.${(0, $8zHUo$nodecrypto.randomUUID)()}.tmp`;
    try {
        if (typeof url === "object" || url.startsWith("http://") || url.startsWith("https://")) await $3122cfee675f370d$var$cacheURL(url, temporaryDestination, fetchOptions);
        else if (url.startsWith("file://")) await $3122cfee675f370d$var$cacheFile((0, $8zHUo$nodepath.normalize)(decodeURIComponent(new URL(url).pathname)), temporaryDestination, fetchOptions?.signal ? fetchOptions.signal : undefined);
        else throw new Error("Only HTTP(S) or file URLs are supported");
        await (0, $8zHUo$nodefspromises.rename)(temporaryDestination, destination);
    } catch (error) {
        await (0, $8zHUo$nodefspromises.rm)(temporaryDestination, {
            force: true
        }).catch(()=>undefined);
        throw error;
    }
...
async function $832d6ad39638ce0c$export$4cff4f142f384da7(databasePath, query, options) {
    ...
    try {
        return $832d6ad39638ce0c$var$executeWithNodeSQLite(sqlite3, databasePath, query, abortSignal);
    } catch (error) {
        if ($832d6ad39638ce0c$var$isDatabaseBusy(error)) {
            ...
            const workaroundCopiedDb = await $832d6ad39638ce0c$var$createDatabaseCopy(databasePath, abortSignal);
            return $832d6ad39638ce0c$var$executeWithNodeSQLite(sqlite3, workaroundCopiedDb, query, abortSignal);
        }
        throw error;
    }
}
function $832d6ad39638ce0c$var$executeWithNodeSQLite(sqlite3, databasePath, query, abortSignal) {
...
function $832d6ad39638ce0c$var$isDatabaseBusy(error) {
    if (!(error instanceof Error)) return false;
    const errorWithCode = error;
    return errorWithCode.errcode === 5 || errorWithCode.errcode === 14 || error.message.includes("(5)") || error.message.includes("(14)");
}
async function $832d6ad39638ce0c$var$createDatabaseCopy(databasePath, abortSignal) {
    ...
    $832d6ad39638ce0c$var$checkAborted(abortSignal);
    const workaroundCopiedDb = (0, ($parcel$interopDefault($8zHUo$nodepath))).join(tempFolder, "db.db");
    try {
        await (0, $8zHUo$nodefspromises.copyFile)(databasePath, workaroundCopiedDb);
    } catch (error) {
        if (process.platform === "darwin" && error instanceof Error && "code" in error && error.code === "EPERM") throw new $832d6ad39638ce0c$export$cb7dc23b705f5c86("You do not have permission to access the database.");
        throw error;
    }
...
async function $832d6ad39638ce0c$var$sqliteFallback(databasePath, query, options) {
    ...
    if (error || exitCode !== 0 || signal !== null) {
        if (process.platform === "darwin" && stderrResult.includes("authorization denied")) throw new $832d6ad39638ce0c$export$cb7dc23b705f5c86("You do not have permission to access the database.");
...
function $908f00f283581e25$export$d74ef0af94fb1db6(databasePath, query, options) {
    ...
    const abortable = (0, $8zHUo$react.useRef)(null);
    const handleError = (0, $8zHUo$react.useCallback)((error)=>{
        console.error(error);
    ...
    const handleData = (0, $8zHUo$react.useCallback)((data)=>{
        setPermissionView(null);
        return latestOptions.current.onData?.(data);
    }, [
        latestOptions
    ]);
    const fn = (0, $8zHUo$react.useCallback)(async (databasePath, query)=>{
...
function $c3d9e48f722f6b4c$export$835fc3bd312a97c(prompt, options = {}) {
    ...
    const abortable = (0, $8zHUo$react.useRef)(null);
    const requestIdRef = (0, $8zHUo$react.useRef)(0);
    const { isLoading: isLoading, error: error, revalidate: revalidate } = (0, $1f5338676d90e7a6$export$dd6b79aaabe7bc37)(async (prompt, creativity, shouldStream, model)=>{
...
function $488f69277de5b02c$var$getNewFrecency(item) {
    const now = Date.now();
    const visitAgeInDays = item ? (now - item.lastVisited) / $488f69277de5b02c$var$MS_PER_DAY : 0;
    const decay = Math.exp(-(Math.log(2) / $488f69277de5b02c$var$HALF_LIFE_DAYS) * visitAgeInDays);
    const totalVisitValue = (item?.frecency ?? 0) * decay + $488f69277de5b02c$var$VISIT_TYPE_POINTS.Default;
    return {
        lastVisited: now,
...
function $bd2f41db5e016369$var$normalizeTokenResponse(tokens) {
...
class $bd2f41db5e016369$export$905bf243392675e9 {
   ...
   */ async authorize() {
    ...
    async fetchTokens({ authRequest: authRequest, authorizationCode: authorizationCode }) {
        ...
        return $bd2f41db5e016369$var$normalizeTokenResponse(tokens);
    }
    async refreshTokens({ token: token }) {
        ...
        if (!response.ok) {
            ...
            return $bd2f41db5e016369$var$normalizeTokenResponse(tokenResponse);
        }
    }
}
...
let $335119ff9d5923ac$var$accessToken;
let $335119ff9d5923ac$var$accessTokenPromise = null;
let $335119ff9d5923ac$var$idTokenPromise = null;
let $335119ff9d5923ac$var$onAuthorizePromise = null;
function $335119ff9d5923ac$export$d6bc6f4110e73ed6(options) {
    ...
    const authorize = ()=>{
        $335119ff9d5923ac$var$accessTokenPromise ??= (personalAccessToken ? Promise.resolve(personalAccessToken) : options.authorize().then((token)=>({
                token: token,
                type: "oauth"
            }))).catch((error)=>{
            $335119ff9d5923ac$var$accessTokenPromise = null;
            throw error;
        });
        return $335119ff9d5923ac$var$accessTokenPromise;
    };
    const getIdToken = ()=>{
        if (!options.client) return undefined;
        $335119ff9d5923ac$var$idTokenPromise ??= options.client.getTokens().then((tokens)=>tokens?.idToken, (error)=>{
            $335119ff9d5923ac$var$idTokenPromise = null;
            throw error;
        });
        return (0, ($parcel$interopDefault($8zHUo$react))).use($335119ff9d5923ac$var$idTokenPromise);
    };
    const runOnAuthorize = (accessToken, idToken)=>{
        if (!options.onAuthorize) return;
        $335119ff9d5923ac$var$onAuthorizePromise ??= Promise.resolve(options.onAuthorize({
            ...accessToken,
            idToken: idToken
        })).catch((error)=>{
            $335119ff9d5923ac$var$onAuthorizePromise = null;
            throw error;
        });
        return $335119ff9d5923ac$var$onAuthorizePromise;
    };
    if ((0, $8zHUo$raycastapi.environment).commandMode === "no-view") return (fn)=>{
        const noViewFn = async (props)=>{
            $335119ff9d5923ac$var$accessToken = await authorize();
            const idToken = (await options.client?.getTokens())?.idToken;
            await runOnAuthorize($335119ff9d5923ac$var$accessToken, idToken);
            return fn(props);
        };
        return noViewFn;
    };
    return (Component)=>{
        const WrappedComponent = (props)=>{
            $335119ff9d5923ac$var$accessToken = personalAccessToken || (0, ($parcel$interopDefault($8zHUo$react))).use(authorize());
            const idToken = getIdToken();
            const onAuthorize = runOnAuthorize($335119ff9d5923ac$var$accessToken, idToken);
            if (onAuthorize) (0, ($parcel$interopDefault($8zHUo$react))).use(onAuthorize);
            return /*#__PURE__*/ (0, ($parcel$interopDefault($8zHUo$react))).createElement(Component, props);
        };
...
function $335119ff9d5923ac$export$84773cc9bf7dbe87() {
    if (!$335119ff9d5923ac$var$accessToken) throw new Error("getAccessToken must be used when authenticated (eg. used inside `withAccessToken`)");
    return $335119ff9d5923ac$var$accessToken;
}
...
async function $ca034de50c750bbf$export$8982d27dc997624f(script, optionsOrArgs, options) {
    ...
    return (parseOutput ?? (0, $abcdf0eb4757394f$export$a8f5efe603803b77))({
        stdout: stdout,
        stderr: stderr,
        error: error,
        exitCode: exitCode,
